...
func _ready() -> void:
	var testando_load_game = SaveGame.load_game()
	if testando_load_game != null:
		Preferencias.vitorias = testando_load_game.vitorias
		Preferencias.choose_marker = testando_load_game.choose_marker
		Preferencias.prefered_language = testando_load_game.prefered_language
	_return_main()
